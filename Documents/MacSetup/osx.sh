...
/usr/libexec/PlistBuddy -c "Set :DesktopViewFinder:IconViewSettings:showItemInfo true" ~/Library/Preferences/com.apple.finder.plist
...
for app in "Activity Monitor" "Dock" "Finder" "Spotlight" \
 	"SizeUp" "Spectacle" "SystemUIServer"; do
