# Generated by Powerlevel10k configuration wizard on 2021-05-22 at 12:53 +06.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    node_version            # node.js version (project-only via POWERLEVEL9K_NODE_VERSION_PROJECT_ONLY)
    rbenv                   # ruby version from rbenv (https://github.com/rbenv/rbenv)
    kubecontext             # current kubernetes context (https://kubernetes.io/)
    terraform               # terraform workspace (https://www.terraform.io)
    aws                     # aws profile
    gcloud                  # google cloud cli account and project
    context                 # user@hostname (SSH/sudo only)
  ...
  function my_git_formatter() {
    ...
    # "─" if the number of unstaged files is unknown — suppressed intentionally.
